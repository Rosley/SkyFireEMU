...
#pragma pack(push,1)
    ...
    public:
        enum Flags
        {
            ...
            Enter_Cycle         = 0x00100000,           // Every time appears with cyclic flag in monster move packet, erases first spline vertex after first cycle done
            ...
            Mask_Unused = No_Spline | Enter_Cycle | Frozen    | Unknown5  | Unknown6  | Unknown7
