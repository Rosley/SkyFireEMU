...
namespace Movement
{
    ...
    const char * g_SplineFlag_names[32]=
    {
        ...
        STR(Done         ),     // 0x00000100,
        STR(Falling      ),     // 0x00000200,           // Not Compatible With Trajectory Movement
        STR(No_Spline    ),     // 0x00000400,
        STR(Trajectory   ),     // 0x00000800,           // Not Compatible With Fall Movement
        ...
        STR(Enter_Cycle  ),     // 0x00100000,           // Every time Appears With Cyclic Flag In Monster Move Packet
        STR(Animation    ),     // 0x00200000,           // Animationid (0...3), Uint32 Time, Not Compatible With Trajectory And Fall Movement
